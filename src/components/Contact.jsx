...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-full flex flex-col justify-center items-center bg-gray-200"
    >
      <div className="max-w-[1300px] grid grid-cols-1 gap-6 my-6 sm:grid-cols-2">
        ...
        <div className="reletive w-full h-96">
          <iframe
            title="Google Map"
            class="top-0 left-0 w-full h-full shadow-2xl"
        ...
        {/* Address info */}
        <div className="flex flex-col justify-center items-center p-9  text-sm">
